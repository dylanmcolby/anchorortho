  ...
  return {
    ...
    LABELS: {
      ...
      TEXT_MESSAGE_CONSENT: {
        english: 'I consent to receive text messages at this phone number. Message frequency varies. Reply STOP to opt-out/ HELP for more information.',
        spanish: 'Doy mi consentimiento para recibir mensajes de texto en este número de teléfono. La frecuencia de los mensajes es de 2 a 6 mensajes por mes. Responda DETENER para darse de baja/ AYUDA para obtener más información.',
        french: 'J\'accepte de recevoir des SMS à ce numéro de téléphone. La fréquence des messages est de 2 à 6 messages par mois. Répondez STOP pour vous désinscrire/AIDE pour plus d\'informations.'
      },
      VIEW_PRIVACY_POLICY: {
  ...
  var FORM_DATA_MAP = {
    ...
    textMessageConsent: {
      ...
      label: function label() {
        ...
        var part1 = _getText('LABEL.TEXT_MESSAGE_CONSENT');

        var part2 = _getText('LABEL.VIEW_PRIVACY_POLICY');

        return "<span>".concat(part1, " </span><a href=\"").concat(privacyPolicyUrl, "\" target=\"_blank\">").concat(part2, "</a>");
      },
      show: function show() {
        var isSubmitted = CONFIG.IS_SUBMITTED;
        return isSubmitted === false && showFormDetailInputs();
